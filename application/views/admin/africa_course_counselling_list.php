...
<div class="main-content">
    <div class="wrap-content container" id="container">
        ...
        <div class="container-fluid container-fullw bg-white">
            <div class="row">
                 <a class="pull-right btn btn-primary btn-large" style="margin-right:40px" href="<?php echo base_url().'admin/Lead/createxlsAfrica'?>"><i class="fa fa-plus"></i> Download CSV</a>
