...
<div class="main-content">
    <div class="wrap-content container" id="container">
        <section id="page-title">
            <div class="row">
                <div class="col-sm-8">
                    <h1 class="mainTitle">Newsletter List </h1>
        ...
        <div class="container-fluid container-fullw bg-white">
            <div class="row">
                 <a class="pull-right btn btn-primary btn-large" style="margin-right:40px" href="<?php echo base_url().'admin/Lead/createxlsNews'?>"><i class="fa fa-plus"></i> Download CSV</a>
