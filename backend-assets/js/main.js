...
var Main = function () {
    ...
    var base_url = "http://localhost/pop_shop/";
    MEDIAQUERY = {
        desktopXL: 1200,
        desktop: 992,
        tablet: 768,
    ...
    var settingsHandler = function () {
        ...
        $('#skin_color').attr("href", base_url + "backend-assets/css/themes/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function () {
            ...
            $('#skin_color').attr("href", base_url + "backend-assets/css/themes/" + selectedTheme + ".css");
        ...
        function switchLogo(theme) {
            switch (theme) {
                ...
                case "theme-5":
                case "theme-6":
                    $(".navbar-brand img").attr("src", base_url + "backend-assets/images/logo1.png");
                    break;
        ...
        function defaultSetting() {
            ...
            $('#skin_color').attr("href", base_url + "/backend-assets/css/themes/theme-1.css");
            $(".navbar-brand img").attr("src", base_url + "/backend-assets/images/logo1.png");
